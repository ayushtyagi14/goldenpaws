...
const Hero = () => {
    return (
        <div className="relative bg-cover bg-center h-[70vh] lg:h-[95vh]"  style={{ backgroundImage: "url('/assets/certification-hero.jpg')" }}>
            <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                ...
                >
                    <h1 className={`${platypi.className} lg:text-[54px] md:text-[42px] text-[24px] font-bold mb-4`}>
                        Certification & Breeder Information
                    </h1>
                    <p className="lg:text-[24px] text-[18px] mb-6 uppercase tracking-widest md:w-[60%] mx-auto">
                        Learn about our professional breeders and health guarantee
                    </p>
                </motion.div>
            </div>
        </div>
